        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (model.Behaviour)
            {
                case EnemyBehaviour.CHASING:
                    model.TrackingObject = (Transform) EditorGUILayout.ObjectField("    Chasing target",
                        model.TrackingObject, typeof(Transform), true);
                    break;
                case EnemyBehaviour.TRACKING:
                    model.TrackingObject = (Transform) EditorGUILayout.ObjectField("    Tracking target",
                        model.TrackingObject, typeof(Transform), true);
                    break;
                case EnemyBehaviour.RANDOM_PATROL:
                    model.MaxRandomSphereSize =
                        EditorGUILayout.FloatField("    Sphere size", model.MaxRandomSphereSize);
                    break;
            }
